      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-teal-100 rounded-full mb-4">
            ...
            <span className="text-sm font-semibold text-teal-600">Frequently Asked Questions</span>
          </div>
        ...
        <div className="space-y-12">
          {/* About ELSA AI */}
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-6 pb-2 border-b-2 border-teal-200">
              About ELSA AI
            </h2>
            <div className="space-y-6">
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">What is ELSA AI?</h3>
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">Are you the same as ELSA Speak (the English‑learning app)?</h3>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">Do you offer language‑learning or pronunciation tools?</h3>
                <p className="text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">What is GenAI Assure?</h3>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">What's the relationship between ELSA AI and GenAI Assure?</h3>
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">Who is GenAI Assure designed for?</h3>
                <p className="text-gray-700 leading-relaxed mb-3">
                  AI deployers—organisations using third‑party AI services such as:
                </p>
                <ul className="text-gray-700 leading-relaxed space-y-1 list-disc list-inside ml-4">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">What problems does GenAI Assure address?</h3>
                <ul className="text-gray-700 leading-relaxed space-y-2 list-disc list-inside">
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">How does implementation work?</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                  We run a 90‑day phased programme:
                </p>
                <div className="space-y-4">
                  <div className="bg-teal-50 rounded-lg p-4 border border-teal-200">
                    <h4 className="font-semibold text-gray-900 mb-2">Days 1–30: Foundation</h4>
                  ...
                  <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                    <h4 className="font-semibold text-gray-900 mb-2">Days 31–60: Core Controls</h4>
                    <ul className="text-gray-700 text-sm space-y-1 list-disc list-inside">
                  ...
                  <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                    <h4 className="font-semibold text-gray-900 mb-2">Days 61–90: Optimisation & Scale</h4>
                    <ul className="text-gray-700 text-sm space-y-1 list-disc list-inside">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">Is GenAI Assure software or a managed service?</h3>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">Who does what (roles & responsibilities)?</h3>
                <div className="space-y-4 mt-4">
                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    <h4 className="font-semibold text-gray-900 mb-2">Your team (Client):</h4>
                    <ul className="text-gray-700 text-sm space-y-1 list-disc list-inside">
                  ...
                  <div className="bg-teal-50 rounded-lg p-4 border border-teal-200">
                    <h4 className="font-semibold text-gray-900 mb-2">ELSA AI (Advisory):</h4>
                    <ul className="text-gray-700 text-sm space-y-1 list-disc list-inside">
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">What frameworks and regulations does GenAI Assure map to?</h3>
                <p className="text-gray-700 leading-relaxed mb-3">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">What audit evidence will we have?</h3>
                <p className="text-gray-700 leading-relaxed mb-3">
                  Evidence Packs per use case, including:
                </p>
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Policy & Governance:</h4>
                    <p className="text-gray-700 text-sm">AI Use Policy, approvals, exception register; lifecycle gate records</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Legal & Compliance:</h4>
                    <p className="text-gray-700 text-sm">DPIA/FRIA, RoPA entries, Transfer Register, transparency labels/notices</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Technical Controls:</h4>
                    <p className="text-gray-700 text-sm">SIEM logs (prompts/outputs/decisions), DLP policies & violations, SSO/SCIM reports, secrets/token inventories, vendor attestations (SOC 2/ISO, sub‑processors)</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Testing & Validation:</h4>
                    <p className="text-gray-700 text-sm">TEVV‑Lite results (bias, explainability, HITL), IR runbooks & transcripts, accessibility conformance</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Format & Assurances:</h4>
                    <p className="text-gray-700 text-sm">Evidence YAML manifests with SHA‑256 hashes and WORM/append‑only storage; tiered retrieval SLA (Tier‑1 ≤4h, Tier‑2 ≤8h, Tier‑3 ≤24h)</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">How do you price engagements?</h3>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">What determines my tier?</h3>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">What's included in every engagement?</h3>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">How are milestones & billing structured?</h3>
                <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">What technical stack do we need?</h3>
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Minimum stack:</h4>
                    <ul className="text-gray-700 text-sm space-y-1 list-disc list-inside">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Enhanced capabilities:</h4>
                    <ul className="text-gray-700 text-sm space-y-1 list-disc list-inside">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">Does GenAI Assure cover model development or fine‑tuning?</h3>
                <p className="text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">How is GenAI Assure licensed?</h3>
                <p className="text-gray-700 leading-relaxed mb-3">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">Can we access the framework before engaging?</h3>
                <p className="text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">How do we know if we need GenAI Assure?</h3>
                <p className="text-gray-700 leading-relaxed mb-3">
                  You likely do if:
                </p>
                <ul className="text-gray-700 leading-relaxed space-y-2 list-disc list-inside">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3">What's the first step?</h3>
                <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <a href="mailto:contact@elsaai.co.uk" className="text-gray-700 hover:text-teal-600 transition-colors">
                    contact@elsaai.co.uk
                  </a>
                </div>
                <div className="flex items-center gap-3">
                  <Globe className="h-5 w-5 text-teal-600" />
                  <a href="https://elsaai.co.uk/" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-teal-600 transition-colors">
                    https://elsaai.co.uk/
                  </a>
                </div>
                <div className="flex items-center gap-3">
                  <Linkedin className="h-5 w-5 text-teal-600" />
                  <a href="https://www.linkedin.com/in/elsa-ai" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-teal-600 transition-colors">
